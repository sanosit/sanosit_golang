...
func main() {
	...
	for {
		...
		if len(lineFields) < 3 {
			fmt.Print("Необходимо ввести имя, возраст и курс! Пожалуйста, попробуйте снова...\n")
			continue
		}
		...
		if errAge != nil || errGrade != nil {
			fmt.Print("Ошибка при обработке возраста студента и его курса! Пожалуйста, попробуйте снова...\n")
			continue
		}
